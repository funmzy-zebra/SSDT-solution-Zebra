...
CREATE PROCEDURE [dbo].[BQ1_Manual_MasterdataLoadAppendByID_ETL_OLD] 
...
BEGIN
	...
	SET @shell_cmd = 'gcloud config set project thd-prf-gcp';	
	...
	EXEC sp_nextgen_etl_run_cmd @shell_cmd
		 ...
		 --  EXEC sp_nextgen_etl_run_cmd @fullPath;
           ...
           SELECT @gcpDataSet = 'BQ_THD'--[NvarcharValue] FROM [NextGenETL].[dbo].[ETLConfig_PiplineRun] where ConfigKey = 'BQ1_DataSet'
